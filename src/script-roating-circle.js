...
window.addEventListener('load', () => {
    ...
    const geometry = new THREE.CircleGeometry( 1, 8 ).toNonIndexed();
    ...
    function animate() {
        ...
        let momentum = 2;
        let momentumButSameTile = (Math.PI / 180 * (360 * momentum)) + (Math.PI / 180 * (rotateDegs[5] + (deg/2)));
...
console.log(rotateDegs)
    ...
    // circle.rotateY(-0.6613919996057788)
    // circle.rotateX(0.02)
    // circle.rotateZ(0.05)
    scene.add(controls)
    // controls.setSize(2)
